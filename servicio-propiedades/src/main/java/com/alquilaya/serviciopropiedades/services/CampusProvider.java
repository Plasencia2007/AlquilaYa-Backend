...
/**
 * Provee el campus principal (coords + radio) como única fuente de verdad para distancias y
 * validación de cercanía. Lee de servicio-catalogos vía Feign y cachea el valor en memoria con
 * un TTL corto (los datos del campus cambian muy poco). Si catalogos no responde, usa el último
 * valor conocido o, en su defecto, un respaldo fijo — así la creación de propiedades nunca se
 * cae por una caída de catalogos.
 */
@Component
...
public class CampusProvider {
    ...
    // Respaldo unificado: mismas coords que usa el frontend (lib/geo.ts) antes de Fase 2.
    ...
    public Campus get() {
        ...
        // Sin dato fresco: reusar el último conocido o caer al respaldo (no se cachea como válido).
     ...
     * fallback). Lo invoca el listener de eventos de catalogos cuando cambia el campus principal.
     */
