...
public class CercaDeUpeuValidator implements ConstraintValidator<CercaDeUpeu, Object> {
    ...
    // Coordenadas de UPeU Lima (según CLAUDE.md)
    private static final double UPEU_LAT = -11.9878;
    private static final double UPEU_LON = -76.8980;
        ...
        try {
            ...
            if (distancia > radioKm) {
                ...
                ctx.buildConstraintViolationWithTemplate(
                        String.format("La ubicación registrada está a %.2f km — excede el radio de %.1f km permitido desde UPeU Lima",
                                distancia, radioKm))
