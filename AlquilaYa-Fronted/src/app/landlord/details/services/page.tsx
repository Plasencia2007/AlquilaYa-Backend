...
export default function ServicesPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 animate-fade-in">
      ...
      <Card className="border-none shadow-sm bg-muted mb-6">
        <h2 className="text-lg font-black text-foreground mb-4">Catálogo</h2>
      ...
      <Card className="border-none shadow-sm bg-muted mb-6">
        <h2 className="text-lg font-black text-foreground mb-2">Servicios adicionales</h2>
        ...
        <textarea
          ...
          className="w-full min-h-[100px] rounded-xl bg-background border-none p-4 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-all"
        />
      </Card>
