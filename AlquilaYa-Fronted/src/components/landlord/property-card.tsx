    ...
    <Card padding="none" className="group overflow-hidden border-none shadow-sm hover:shadow-xl transition-all duration-500 bg-muted hover:-translate-y-1">
      <div className="relative aspect-[16/10] overflow-hidden">
        {imagenUrl ? (
          ...
          <div className="w-full h-full bg-background-variant/30 flex items-center justify-center">
            <span className="material-symbols-outlined text-4xl text-muted-foreground/30">image</span>
          </div>
        )}
        ...
        <div className="absolute top-3 right-3">
          <div className="bg-background/90 backdrop-blur-md px-3 py-1.5 rounded-full text-primary font-black text-sm shadow-lg">
      ...
      <div className="p-5">
        <h3 className="font-black text-lg text-foreground tracking-tight mb-1 line-clamp-1 group-hover:text-primary transition-colors">
          {titulo}
        </h3>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button variant="ghost" size="sm" className="w-full rounded-xl border border-border-variant text-xs h-9">
            <span className="material-symbols-outlined text-base mr-2">edit</span>
            Editar
          </Button>
          <Button variant="ghost" size="sm" className="w-full rounded-xl border border-border-variant text-xs h-9 text-destructive hover:bg-destructive/10 hover:text-destructive border-transparent">
